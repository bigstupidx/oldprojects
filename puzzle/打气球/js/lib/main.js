(function(){
	...
	if (typeof WGame === 'undefined') {
        global.WGame = {};
    }
	
	WGame.global = global;
	
	WGame.apply = function(object, config, defaults) {
        if (defaults) {
        	WGame.apply(object, defaults);
        }
    ...
    WGame.apply(WGame,{
    	...
    	parseNamespace: function(namespace) {
            if (typeof namespace != 'string') {
                throw new Error("[WGame] Invalid namespace, must be a string");
            }
