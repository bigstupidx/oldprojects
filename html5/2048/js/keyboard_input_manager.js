...
KeyboardInputManager.prototype.listen = function () {
    ...
    document.addEventListener("keydown", function (event) {
        ...
        if (!modifiers) {
            self.enter.call(self, event);

            // Back to game from share
            self.shareToGame.call(self, event);
        }
    });
...
KeyboardInputManager.prototype.showRank = function (event) {
    console.log("showRank");
    event.preventDefault();
    this.emit("showRank");
};

KeyboardInputManager.prototype.backToGame = function (event) {
