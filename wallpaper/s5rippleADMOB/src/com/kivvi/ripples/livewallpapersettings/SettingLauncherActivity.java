	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				ComponentName component = new ComponentName(SettingLauncherActivity.this, LibgdxLiveWallpaperAndroidService.class);
		...
		button1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(SettingLauncherActivity.this, LiveWallpaperSettingsActivity.class);
...
//		ComponentName component = new ComponentName(this, LibgdxLiveWallpaperAndroidService.class);
//	    Intent intent = new Intent(WallpaperManager.ACTION_CHANGE_LIVE_WALLPAPER);
//	    intent.putExtra(WallpaperManager.EXTRA_LIVE_WALLPAPER_COMPONENT, component);
